...
def cross_validation_best_weight(y,tX,k_fold,degree,seed,lower_lambda,upper_lambda,name_to_add_in_path):
    ...
    for d in range(1,degree):
        ...
        cross_validation_visualization(lambdas, rmse_tr_l, rmse_te_l,name_to_add_in_path+strd)
    ...
    print("Test best error = "  + str(rmse_te[best_index_d]) + "for lambda = " + str(lambdas[best_index_d]) + "and degree = "+ str(best_index_d+1))
    return weights[best_index_d],rmse_te[best_index_d]
